...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600">Edit pembayaran untuk client: {{ $payment->client->name }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('manage.payments.update', $payment) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="amount" name="amount" value="{{ old('amount', $payment->amount) }}" min="0" step="1000"
                ...
                <div>
                    ...
                    <input type="date" id="payment_date" name="payment_date" value="{{ old('payment_date', $payment->payment_date->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="date" id="due_date" name="due_date" value="{{ old('due_date', $payment->due_date->format('Y-m-d')) }}"
            ...
            <div class="mt-6">
                ...
                <textarea id="description" name="description" rows="3"
                          ...
                          placeholder="Enter description (optional)">{{ old('description', $payment->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
