    ...
    <div class="max-w-lg mx-auto bg-white rounded-lg shadow p-8">
        ...
        <form method="POST" action="{{ route('manage.roles.store') }}">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">{{ old('description') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="permissions[]" value="{{ $permKey }}" class="form-checkbox text-blue-600" {{ in_array($permKey, old('permissions', [])) ? 'checked' : '' }}>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition-colors">Add Role</button>
            </div>
        </form>
    </div>
</div>
