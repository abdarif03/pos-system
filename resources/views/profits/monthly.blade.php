        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('profits.export-pdf', ['type' => 'monthly', 'month' => $startDate->format('Y-m')]) }}" class="btn btn-outline-danger">
                            ...
                            <tbody>
                                @foreach($weeklyBreakdown as $week)
                                    <tr>
                                        ...
                                        <td>{{ format_idr($week['revenue']) }}</td>
                                        <td>{{ format_idr($week['cost']) }}</td>
                                        <td class="text-success">{{ format_idr($week['profit']) }}</td>
                                        <td>{{ format_id_number($week['margin'], 1) }}%</td>
                                        <td>
